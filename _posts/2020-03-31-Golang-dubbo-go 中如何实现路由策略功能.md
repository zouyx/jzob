...
permalink: /posts/2020/03/30/dubbo-go 中如何实现路由规则功能.html
---
...
![router-design.png](/images/dubbogo/router/router-design.png)
...
应用名：只对 user-info-server 应用生效
.condition-router: 路由类型。除此之外，还有 .tag-router 表示标签路由。
...
![router-route.png](/images/dubbogo/router/router-route.png)
...
![router-import.png](/images/dubbogo/router/router-import.png)
...
![dubbo-admin-1.png](/images/dubbogo/router/dubbo-admin-1.png)

![dubbo-admin-2.png](/images/dubbogo/router/dubbo-admin-2.png)
...
1. service-router（未支持）
1. 标签路由-配置中心（未支持）
1. 目前路由与配置中心结合的代码，对新增路由规则并不友好，有一定接入成本。
